...
//P4 comment: changed determineDx to take just size as parameter
  function determineDx (size) {
  //function determineDx (elem, size) {
//P4 comment: elemOW is oldwidth obtained from DOMContentLoaded
...
//P4 comment: ww is windowwidth globally available via DOMContentLoaded
...
//P4 comment: pList[] populated in DOMContentLoaded,
...
//P4 comment:  inline style.css into pizza.html
...
//P4 comment: get basicLeft for mover items to array for updatePositions() 
    basLeft[i] = elem.basicLeft;
    elem.style.top = (Math.floor(i / cols) * s) + 'px';
//P4 comment: push mover items to an array for updatePositions() 
